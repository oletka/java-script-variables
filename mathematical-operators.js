...
// ==========================================
const fruitSweet = "sweet";
const fruitJus = "juicy";
const all = "sweet" + "juicy";
console.log(all);
// ==========================================
...
// ==========================================
const residence = "Schoonebeek";
const province = "Drenthe";
const place = residence + ", " + province;
console.log(place);